...
import io.github.jacoblee23.bibleguesser.BibleGuesserApplication;
...
public class Canon {
    ...
    private final LinkedHashMap<String, LinkedHashMap<String, List<String>>> data;

    private Canon() {
        InputStream in = BibleGuesserApplication.class.getResourceAsStream(Canon.PATH);
        Yaml yaml = new Yaml();
    ...
    public List<String> getTestaments() {
        List<String> testaments = new ArrayList<>();
